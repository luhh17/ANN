...
from save_list import save_list, load_list
...
tf.app.flags.DEFINE_float("drop_rate", 0.2, "drop out rate")
...
with tf.Session() as sess:
    ...
    if FLAGS.is_train:
        ...
        save_list(train_acc_list, "train_acc")
        save_list(val_acc_list, "val_acc")
        save_list(train_loss_list, "train_loss")
        save_list(val_loss_list, "val_loss")
